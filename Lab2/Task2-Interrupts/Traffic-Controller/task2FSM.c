// ______________________ Task 2c FSM Program (.c) ______________________
/*
* Kiana Peterson & Nattapon "Genie" Oonlamom
* Lab 2 Task 2c
* November 2nd, 2023
* This program creates an FSM that sets the value of each LED depending on what
*   button is pressed at a certain state and determines the next state. This FSM
*   is for a traffic controller.
*/
